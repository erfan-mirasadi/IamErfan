  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        <a
          href="https://www.linkedin.com/in/erfan-mirasadi-9b035a328"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center space-x-3 p-4 bg-gray-900 border border-neon-blue hover:bg-gray-800 hover:shadow-[0_0_12px_#00b7eb] transition-all duration-300 rounded-md text-2xl text-neon-blue"
        >
